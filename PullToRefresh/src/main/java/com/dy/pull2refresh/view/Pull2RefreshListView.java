...
public class Pull2RefreshListView extends ListView implements OnScrollListener,
	...
	/** 刚开始隐藏加载更多bar */
	private boolean mHideLoadMore = false;
	...
	public void setCanLoadMore(boolean pCanLoadMore) {
		...
		if (null != mEndRootView && !pCanLoadMore) {
	...
	public void setHideLoadMore(boolean pHideLoadMore) {
		if (null != mEndRootView && pHideLoadMore) {
